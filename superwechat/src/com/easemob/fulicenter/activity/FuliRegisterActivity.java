...
import com.easemob.fulicenter.listener.OnSetAvatarListener;
import com.easemob.fulicenter.utils.I;

import java.io.File;

public class FuliRegisterActivity extends BaseActivity {
    ...
    private void setListener() {
        findViewById(R.id.layout_person_register).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.avatar).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mOnSetAvatarListener = new OnSetAvatarListener(FuliRegisterActivity.this, R.id.activity_register, avatarName, I.AVATAR_TYPE_USER_PATH);
            }
        });
    }
    ...
    private void registerAppServer() {
        //暂时传入后缀的jpg的图片
        File file = new File(OnSetAvatarListener.getAvatarPath(FuliRegisterActivity.this, I.AVATAR_TYPE_USER_PATH), avatarName + I.AVATAR_SUFFIX_JPG);
        ...
        utils.setRequestUrl(I.REQUEST_REGISTER)
                ...
                .execute(new OkHttpUtils2.OnCompleteListener<Result>() {
                    ...
                    public void onSuccess(Result result) {
                        Log.i("main", "result111==" + result.toString());
                        if (!result.isRetMsg()) {
                            registerEMServer();
                        } else {
                            pd.dismiss();
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            if (!FuliRegisterActivity.this.isFinishing())
                                pd.dismiss();
                            // 保存用户名
