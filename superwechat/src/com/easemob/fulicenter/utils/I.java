...
public interface I {
    ...
    String DOWNLOAD_USER_AVATAR_URL                 =       I.SERVER_TOOL
            +  "?" + KEY_REQUEST + "=" + REQUEST_DOWNLOAD_AVATAR + "&" + AVATAR_TYPE + "=";
    /** 客户端发送的根据根据群组环信id下载群组头像的请求 */
    String DOWNLOAD_GROUP_AVATAR_URL                 =       I.SERVER_TOOL
    ...
    /** 下载分类商品大类图像的接口*/
    String DOWNLOAD_DOWNLOAD_CATEGORY_GROUP_IMAGE_URL= I.SERVER_TOOL+
    ...
    /** 下载收藏商品图像的接口*/
    String DOWNLOAD_GOODS_THUMB_URL= I.SERVER_TOOL+
    ...
    /** 下载分类商品小类图像的接口*/
    String DOWNLOAD_DOWNLOAD_CATEGORY_CHILD_IMAGE_URL= I.SERVER_TOOL+
        "?request="+REQUEST_DOWNLOAD_CATEGORY_GROUP_IMAGE
    ...
    /**壹收款服务端支付URL*/
    String PAY_URL= I.SERVER_TOOL+"?request="+I.REQUEST_PAY;
